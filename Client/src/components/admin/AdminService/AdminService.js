...
import ACTION_ON_UPCOMING_PAGE_RESET from "../../../actions/Admin/OnUpcomingPage/ACTION_ON_UPCOMING_PAGE_RESET";
...
const AdminService = (props) => {
  ...
  const onUpcomingPage = useSelector(
    (state) => state.onUpcomingPage.on_upcoming_page
  );
  ...
  useEffect(() => {
    if (onUpcomingPage) {
      ...
      dispatch(ACTION_ON_UPCOMING_PAGE_RESET());
    }
  }, [onUpcomingPage, dispatch, resetNotifications, adminNotifications]);
