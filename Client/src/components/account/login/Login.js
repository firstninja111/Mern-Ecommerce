...
import updateClientPasswordMutation from "../../../graphql/mutations/updateClientPasswordMutation"
import updateClientIsOnlineMutation from "../../../graphql/mutations/updateClientIsOnlineMutation"
import NewPassword from "./NewPassword/NewPassword";
import ConfirmNewPassword from "./NewPassword/ConfirmNewPassword";
...
const Login = (props) => {
  ...
  const [isOnlineUpdated, changeIsOnlineUpdated] = useState(false);
  ...
  const [
    ...
    { loading: updateClientPasswordLoading, data: updateClientPasswordData },
  ] = useMutation(updateClientPasswordMutation);

  const [
    updateClientIsOnline,
    { loading: updateClientIsOnlineLoading, data: updateClientIsOnlineData },
  ] = useMutation(updateClientIsOnlineMutation);
  ...
  useMemo(() => {
    if (!updateClientPasswordLoading) {
      if (updateClientPasswordData) {
        loginClient({
          variables: {
            email: updateClientPasswordData.updateClientPassword.email,
      ...
      <div className="login_container">
        ...
        <div className="login_section_designator">
          {!temporaryDummyToken
            ...
            : <p>Change the password to your administrative account</p>
          }
        </div>
        ...
        <div className="bottom_buttons_container">
          ...
          >
            <p>{temporaryDummyToken ? "Change Password" : "Log In"}</p>
          </Link>
