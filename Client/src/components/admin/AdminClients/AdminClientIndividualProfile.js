...
import assignNewPasswordClientMutation from "../../../graphql/mutations/assignNewPasswordClientMutation";
...
const AdminClientIndividualProfile = (props) => {
  ...
  const [assignNewPasswordClient, { loading: assignLoading, data: assignData}] = useMutation(assignNewPasswordClientMutation)
            ...
            ((styleprops) => (
              ...
              >
                <div className="log_out_modal_contents admin_cancel_appointment">
                  ...
                  />
                  <h2>
                    Are you sure you want to assign a new password to a client {" "}
                    {props.item.firstName[0].toUpperCase() +
                      props.item.firstName.slice(1).toLowerCase() +
                      " " +
                      props.item.lastName[0].toUpperCase() +
                  ...
                  <span className="logout_buttons_container">
                    <div
                      className="logout_button yes_cancel_appointment_button"
                      onClick={() => handleAssignNewPassword(props.clientToggled)}
                    >
                      <p>YES, ASSIGN</p>
                    </div>
                    <div
          ...
          props.getEmployeeData.employee ? (
              ...
              >
                <FontAwesomeIcon
                  ...
                  icon={faKey}
                />
                <h2>Assign New Temporary Password</h2>
              </div>
          ) : null
        ) : null}
        {props.getEmployeeData ? (
