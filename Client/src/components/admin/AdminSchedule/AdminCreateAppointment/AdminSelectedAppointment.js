            ...
            >
              ...
              <div className="my_individual_selected_appointment_contents_container">
                ...
                <a 
                  ...
                  href={`https://meet.jit.si/${allAdminAppointments.filter( (x) => x._id === currentToggledAppointment)[0]._id}`} target="_blank"
                >
                  Join to the Meeting
                </a>
                </div>
                <div className="selected_appointments_bottom_buttons_container">
                  ...
                  <div
                    className="back_to_all_appointments_button width_45p"
