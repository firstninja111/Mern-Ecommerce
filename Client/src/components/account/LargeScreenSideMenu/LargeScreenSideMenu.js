...
const LargeScreenSideMenu = React.forwardRef((props, ref) => {
  ...
  const [isManagement, setIsManagementOpen] = useState(false);
    ...
    >
      <div>
              ...
              <p>
                <b>
                  { getClientData
                    ...
                    : getEmployeeData
                      ? getEmployeeData.employee
                        ? getEmployeeData.employee.store
                          ? "Store: " + getEmployeeData.employee.store.name
                          : ""
                        : ""
                      : ""
                  }
              ...
              <p>
                <b>
                  ...
                  { getClientData
                    ...
                    : getEmployeeData
                    ? getEmployeeData.employee
                      ? " " + getEmployeeData.employee.employeeRole[0]
                      : " Staff"
                    : " Staff"
                  }
                </b>
        ...
        <div className="large_screen_side_menu_all_items_container">
          {userAuthenticated && <div className="large_screen_side_menu_item_container">
            <div
          ...
          <div className="large_screen_side_menu_item_container">
            <Collapsible
              trigger={
                <div className="collabsible-wrapper large_screen_side_menu_item" >
                  <FontAwesomeIcon
                    icon={faHome}
                    className="large_screen_side_menu_item_icon"
                  />
              ...
              triggerWhenOpen={
                <div className="collabsible-wrapper large_screen_side_menu_item trigger-open" >
                  <FontAwesomeIcon
                    icon={faHome}
                    className="large_screen_side_menu_item_icon"
                  />
            ...
            >
              <ul>
                <li style={{marginTop: "10px"}}>
                  <Link
                    className="large_screen_side_menu_item"
                    to="/admin/appointments/upcoming"
                  >
                    {
                      isAppointmentOpen && location.pathname.includes("appointments/upcoming") && 
                      <div className="large_screen_side_menu_item_selected_border"/>
                    }
                ...
                <li style={{marginTop: "10px"}}>
                  <Link
                    className="large_screen_side_menu_item"
                    to="/admin/appointments/checkedin"
                  >
                    {
                      isAppointmentOpen && location.pathname.includes("appointments/checkedin") && 
                      <div className="large_screen_side_menu_item_selected_border"/>
                    }
                    <h2>Checked-in</h2>
                  </Link>
                ...
                <li style={{marginTop: "10px"}}>
                  <Link
                    className="large_screen_side_menu_item"
                    to="/admin/appointments/inprogress"
                  >
                    {
                      isAppointmentOpen && location.pathname.includes("appointments/inprogress") && 
                      <div className="large_screen_side_menu_item_selected_border"/>
                    }
                    <h2>In-Progress</h2>
                  </Link>
                ...
                <li style={{marginTop: "10px"}}>
                  <Link
                    className="large_screen_side_menu_item"
                    to="/admin/appointments/history"
                  >
                    {
                      isAppointmentOpen && location.pathname.includes("appointments/history") && 
                      <div className="large_screen_side_menu_item_selected_border"/>
                    }
                    <h2>History</h2>
                  </Link>
          ...
          {getEmployeeData && getEmployeeData.employee && getEmployeeData.employee.employeeRole && getEmployeeData.employee.employeeRole.includes("Admin") ? (
            ...
            >
              ...
              >
                <ul>
                  <li style={{marginTop: "10px"}}>
                    <Link className="large_screen_side_menu_item" to="/admin/management/staff">
                      {
                        isManagement && location.pathname.includes("management/staff") && 
                        <div className="large_screen_side_menu_item_selected_border"/>
                      }
                      <h2>Team</h2>
                    </Link>
                  ...
                  <li style={{marginTop: "10px"}}>
                    <Link className="large_screen_side_menu_item" to="/admin/management/service">
                      {
                        isManagement && location.pathname.includes("management/service") && 
                        <div className="large_screen_side_menu_item_selected_border"/>
                      }
                      <h2>Service</h2>
                    </Link>
                  ...
                  <li style={{marginTop: "10px"}}>
                    <Link className="large_screen_side_menu_item" to="/admin/management/store">
                      {
                        isManagement && location.pathname.includes("management/store") && 
                        <div className="large_screen_side_menu_item_selected_border"/>
                      }
                      <h2>Store</h2>
                    </Link>
                  ...
                  <li style={{marginTop: "10px"}}>
                    <Link className="large_screen_side_menu_item" to="/admin/management/agenda">
                      {
                        isManagement && location.pathname.includes("management/agenda") && 
                        <div className="large_screen_side_menu_item_selected_border"/>
                      }
                      <h2>Update Agenda</h2>
                    </Link>
      ...
      <div>
        ...
        <p className="large_screen_side_menu_item_container">
          &copy; {new Date().getFullYear()} CHOIREDEX, LLC
        </p>
      </div>
    </div>
  );
