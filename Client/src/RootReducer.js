...
import onUpcomingPageReducer from "./reducers/Admin/OnUpcomingPage/onUpcomingPageReducer";
...
import StoresReducer from "./reducers/Stores/StoresReducer";
import EcommerceReducer from "./reducers/Ecommerce/EcommerceReducer";
import ecommerceMeetNowReducer from "./reducers/Ecommerce/EcommerceMeetNowReducer";
import temporaryDummyTokenReducer from "./reducers/Login/TemporaryDummyToken/temporaryDummyTokenReducer";
import newPasswordReducer from "./reducers/Login/NewPassword/newPasswordReducer";
import confirmNewPasswordReducer from "./reducers/Login/ConfirmNewPassword/confirmNewPasswordReducer";
import newPasswordInvalidReducer from "./reducers/Login/NewPassword/Invalid/newPasswordInvalidReducer";
import confirmNewPasswordInvalidReducer from "./reducers/Login/ConfirmNewPassword/Invalid/confirmNewPasswordInvalidReducer";
import newPasswordValidReducer from "./reducers/Login/NewPassword/Valid/newPasswordValidReducer";
import confirmNewPasswordValidReducer from "./reducers/Login/ConfirmNewPassword/Valid/confirmNewPasswordValidReducer";
import onCheckedInPageReducer from "./reducers/Admin/OnCheckedInPage/onCheckedInPageReducer";

const RootReducer = combineReducers({
  // Reducers for "LEARN MORE" button on treatments/add-ons on mobile
  // Treatments
  storePageActive: StoresReducer,
  ecommercePageActive: EcommerceReducer,
  ecommerceMeetNowActive: ecommerceMeetNowReducer,
  ...
  onUpcomingPage: onUpcomingPageReducer,
  on_checkedin_update: onCheckedInPageReducer,
  on_meeting_page: onCheckedInPageReducer,
