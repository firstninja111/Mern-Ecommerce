        ...
        upcomingAppointmentsData.own_appointments.length > 0 ? (
          upcomingAppointmentsData.own_appointments.map((item, i) => {
            const event = {
              ...
              description: "Appointment with the store " + item.store.name,
            ...
            if (item.date) {
              return (
                ...
                >
                  <Modal
                    isOpen={
                      cancelAppointmentClicked && appointmentToggled === item._id
                    }
                  ...
                  <div className="my_appointment_information_container">
                    ...
                    <p className="my_appointment_details">
                      {"Appointment with the store " + item.store.name}
                    </p>
                    <p className="my_appointment_details">
                      {item.duration >= 60
                          ...
                          <div className="my_individual_selected_appointment_contents_container">
                            ...
                            <div className="selected_appointment_meeting_link_container">
                              <a
                                ...
                                href="https://meet.jit.si/gdfgasdfsdfasdasdasdfasdfasfasdasa"
                                target="_blank"
                              >
                                Join to the Meeting
                              </a>
