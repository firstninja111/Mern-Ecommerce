  ...
  return (
    <div className="admin_clients_container">
      ...
      >
        ...
        {getEmployeesData && getEmployeeData
          ? getEmployeesData.employees.length > 0
            ? filteredAllEmployees
                .sort((a, b) => a.firstName.localeCompare(b.firstName))
                .map((item, i) => {
                  if(getEmployeeData.employee.employeeRole.includes("Admin") || item.store._id == getEmployeeData.employee.store._id){
                    return <div
                    ...
                    >
                      ...
                      <div className="admin_individual_client_full_name">
                        ...
                        <p>{item.store ? item.store.name : null}</p>
                      </div>
