...
const updateClientPasswordMutation = require("./mutations/updateClientPasswordMutation");
...
const assignNewPasswordClientMutation = require("./mutations/assignNewPasswordClientMutation");
const assignNewPasswordEmployeeMutation = require("./mutations/assignNewPasswordEmployeeMutation");
const updateClientIsOnlineMutation = require("./mutations/updateClientIsOnlineMutation");
const processAppointmentMutation = require("./mutations/processAppointmentMutation");
const updateAppointmentMutation = require("./mutations/updateAppointmentMutation");
const addAgendaMutation = require("./mutations/addAgendaMutation");
...
const Mutation = new GraphQLObjectType({
  ...
  fields: {
    ...
    updateClientPassword: updateClientPasswordMutation,
    ...
    assignNewPasswordClient: assignNewPasswordClientMutation,
    assignNewPasswordEmployee: assignNewPasswordEmployeeMutation,
    updateClientIsOnline: updateClientIsOnlineMutation,
    processAppointment: processAppointmentMutation,
    updateAppointment: updateAppointmentMutation,
    addAgenda: addAgendaMutation,
  },
});
